...
} from "../../../../../../upload/components/stepper/second-stepper/UploadSecondStepContainer";
import {Box} from "@mui/material";
import {CommonButton} from "../../../../../../../components/button/CommonButton";
import {
    useAlbumPostEditDescription,
    useAlbumPostEditTitle, useAlbumPostTitleAndDescriptionEditMode,
} from "./state/use-edit-title-and-desription-in-album-post.hooks";
import {
    useSetInitialTitleAndDescriptionInAlbumPost
} from "./hooks/use-set-initial-title-and-description-in-album-post.hooks";
...
export const AlbumPostGeneralInformationEditTextGroup = ()=>{
    ...
    const {updateAlbumPost,isUpdating}= useAlbumPostUpdateGeneralInformation()
